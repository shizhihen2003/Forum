  ...
  <div class="row">
    <div class="col-md-9">
      <div class="form-container">
        ...
        <div class="tips-card">
          <div class="tips-title"><i class="bi bi-info-circle"></i> 编辑提示</div>
          <ul class="mb-0">
        ...
        <form id="editForm" onsubmit="return updatePost()">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="summary" id="summary" rows="3"
                      maxlength="500" placeholder="请输入帖子摘要，如不填写将自动提取正文前500字">${post.summary}</textarea>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="https://www.markdown.xyz/basic-syntax/" target="_blank"
             class="btn btn-sm btn-info">查看完整语法</a>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  function updatePost() {
    ...
    // 发送更新请求
    $.ajax({
      url: '${pageContext.request.contextPath}/post/update/' + $('#postId').val(),
      type: 'POST',
      ...
      success: function(response) {
        if (response.code === 200) {
          alert('帖子更新成功！');
          window.location.href = '${pageContext.request.contextPath}/post/detail/' + $('#postId').val();
        } else {
